...
class _VaultScreenState extends State<VaultScreen> with RouteAware, TickerProviderStateMixin {
  ...
  final List<_VaultCategory> _categories = [
    ...
    _VaultCategory(Icons.apps_rounded, 'App Lock', 'app_hider', const Color(0xFFEF4444)),
  ];
    ...
    return Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isLight ? Colors.black12 : Colors.white.withValues(alpha: 0.05),
                  width: 1.5,
                ),
              ),
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withValues(alpha: isLight ? 0.1 : 0.5),
                          blurRadius: 8,
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child: Icon(Icons.enhanced_encryption_rounded, color: isLight ? AppColors.primary : const Color(0xFF4DA3FF), size: 24),
                      ),
                    ),
                  ),
      ...
      floatingActionButton: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: AppColors.primary.withValues(alpha: isLight ? 0.3 : 0.6), blurRadius: 20, offset: const Offset(0, 6))],
        ),
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            Text('Files are uploaded & originals auto-deleted', style: TextStyle(color: isLight ? AppColors.textSecondary : Colors.white.withValues(alpha: 0.3), fontSize: 12)),
            const SizedBox(height: 20),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: color.withValues(alpha: isLight ? 0.15 : 0.08)),
        ),
        child: Row(
          children: [
            Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle, style: TextStyle(color: isLight ? AppColors.textSecondary : Colors.white.withValues(alpha: 0.3), fontSize: 11)),
                ],
              ),
            ),
  ...
  Future<void> _uploadAndDelete(String filePath) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        PremiumSnackbar.show(context, message: 'Uploaded & deleted from phone', emoji: '?', color: const Color(0xFF10B981));
      }
    } catch (e) {
      if (mounted) {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: isLight ? Colors.black.withValues(alpha: 0.06) : Colors.black.withValues(alpha: 0.5)),
                boxShadow: [
                  BoxShadow(color: category.color.withValues(alpha: isLight ? 0.3 : 0.4), blurRadius: 16, spreadRadius: -2),
                  BoxShadow(color: Colors.white.withValues(alpha: isLight ? 1.0 : 0.05), blurRadius: 4, offset: const Offset(-1, -1)), // Top left highlight
                  BoxShadow(color: Colors.black.withValues(alpha: isLight ? 0.05 : 0.5), blurRadius: 4, offset: const Offset(2, 2)), // Bottom right shadow
                ],
              ),
              child: Center(
